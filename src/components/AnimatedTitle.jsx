...
const AnimatedTitle = () => {
  ...
  return (
    ...
    >
      <div className="sticky top-1/2 left-1/2 min-h-[50rem] min-w-[50rem] -translate-x-1/2 -translate-y-1/2 whitespace-nowrap before:absolute before:inset-0 before:scale-[var(--scale)] before:border-[2.5rem] before:border-[#E4E4E7] before:opacity-[var(--opacity-border)]">
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
        ...
        <motion.p
          ...
          className="absolute left-1/2 top-1/2 text-[114px] leading-tight bg-gradient-to-r from-[#A0A0A0] to-[#000000] inline-block text-transparent bg-clip-text"
        >
          Here’s what you
          <br />
          can expect from us...
        ...
        <span className="absolute left-[calc(50%*var(--scale)+50%-(2.5rem*var(--scale)))] top-0 z-[12] h-full w-[50vw] origin-left scale-[var(--scale)] border-l-[2.5rem] border-[#E4E4E7] opacity-[var(--opacity-border)]" />
      </div>
    </motion.section>
  );
};
